...
function EditAddressComponent(props) {
    const [formData, setData] = React.useState({ name: props.editData.name, country: props.editData.country_id, city: props.editData.city, address1: props.editData.address_1, address2: props.editData.address_2, postcode: props.editData.postcode, submited: false });

    const { name, country, city, address1, address2, postcode, submited } = formData;
                ...
                <View style={styles.contentView}>
                    ...
                    <FormControl isRequired isInvalid={submited && 'country' in errors}>
                        <Select
                            ...
                            mt={1}
                            onValueChange={(itemValue) => { setData({ ...formData, submited: false, country: itemValue }), delete errors.country }}
                        >
                            {
