            ...
            <View style={styles.cartContent} key={item.id}>
                <View style={styles.cartBox} >
                    ...
                    <View style={styles.infromationView}>
                        ...
                        <Text style={styles.orderDate}>Ordered On {moment(item.order_date).format("DD MMM YYYY")}</Text>
                        <Text style={styles.orderDate}>Order Status <Text style={styles.orderStatuss}>{item.order_status.name}</Text></Text>
                    </View>
