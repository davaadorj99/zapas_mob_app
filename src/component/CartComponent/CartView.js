...
function CartView(props) {
    ...
    return (
        <>
            ...
            {
                cartProduct.length > 0 && cartProduct.map((data) =>
                    <View style={styles.cartContent} key={data.cart_id}>
                        <View style={styles.cartBox} >
                            ...
                            <View style={styles.infromationView}>
                                <TouchableOpacity style={{ padding: 4 }} onPress={() => props.navigation.navigate('ProductDetailScreen', { id: data.id })}>
                                ...
                                <View style={styles.plusminus}>
                                    ...
                                    <TouchableOpacity style={{ marginLeft: wp('2.5%'), padding: 4 }} onPress={() => props.incrementItem(data.cart_id, data.id, data.quantity)}>
