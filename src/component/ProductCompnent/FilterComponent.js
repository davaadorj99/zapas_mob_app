        ...
        <View>
            ...
            <View style={styles.modelView}>
                ...
                <OtrixHeader customStyles={{ backgroundColor: Colors.light_white }}>
                    <TouchableOpacity style={GlobalStyles.headerLeft} onPress={() => props.closeFilter(false)}>
                    ...
                    <TouchableOpacity style={styles.headerRight} onPress={() => props.closeFilter(true)} >
                ...
                <View style={styles.filterView}>
                    ...
                    <View style={{ flexDirection: 'column', flexWrap: 'wrap', marginHorizontal: wp('1%') }}>
                        {
                            RateList.map((item, index) =>
                                <FilterTags tagName={item.name} tagID={item.value} type="rating" key={item.id} selectedPrice={props.filterPriceVal} selectedRating={props.filterRatingVal} onFilterPress={props.onFilterPress} />
                            )
                        }
                    </View>
