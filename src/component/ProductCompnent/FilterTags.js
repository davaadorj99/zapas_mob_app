...
function FilterTags(props) {
    ...
    if (props.selectedRating != undefined && props.tagID == props.selectedRating) {
        selectedTag = true;
    }
    ...
    return (
        <>
            {
                props.type != undefined && props.type == 'rating' ? <TouchableOpacity style={[styles.filterBox, props.selectedRating != undefined && props.selectedRating == props.tagID ? styles.borderBox : styles.unborderBox]} onPress={() => props.onFilterPress(props.type, props.tagID)}>
            ...
            {
                props.type == undefined && <TouchableOpacity style={[styles.filterBox, selectedTag ? styles.borderBox : styles.unborderBox]} onPress={() => props.onFilterPress(props.type, props.tagID)}>
