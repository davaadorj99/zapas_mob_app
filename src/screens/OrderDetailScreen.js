...
function OrderDetailScreen(props) {
    ...
    const [state, setState] = React.useState({ rateReview: false, loading: false, name: null, star: 0, submited: false, productID: null, message: null, type: 'error' });
    const { rateReview, name, star, message, loading, submited, productID, type } = state;
                                ...
                                <View >
                                    <View style={styles.cartBox} >
                                        ...
                                        <View style={styles.infromationView}>
                                            ...
                                            <Text style={styles.orderDate}>Quantity: {item.quantity}</Text>
                                        </View>
                                    ...
                                    <TouchableOpacity onPress={() => setState({ ...state, productID: item.product_id, rateReview: true })} style={styles.bottomButton}>
                                        <Text style={styles.bottomLeftTxt}> Rate This Product </Text>
                        ...
                        <View style={styles.contentView}>
                            ...
                            <FormControl isRequired isInvalid={submited && 'name' in errors}>
                                <Input variant="outline"
                                    value={name}
                                    placeholder="Review Text" style={GlobalStyles.textInputStyle}
