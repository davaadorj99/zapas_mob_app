...
function LoginScreen(props) {
    ...
    const validate = () => {
        ...
        if (email == null) {
            logfunction("FIeld ", 'Утасны дугаараа оруулна уу')
            setErrors({
                ...errors,
                email: 'Утасны дугаараа оруулна уу'
            });
            return false;
        }
    ...
    return (
        <OtrixContainer>
            ...
            <OtrixHeader customStyles={GlobalStyles.authHeader}>
                <Text style={[GlobalStyles.authtabbarText]}> Захиалгын хуудас</Text>
                <Text style={GlobalStyles.authSubText}>Утасны дугаар болон нэрээ оруулна уу</Text>
            </OtrixHeader>
            ...
            <OtrixContent>
                ...
                <FormControl isRequired style={{ backgroundColor: Colors.white }} isInvalid={submited && 'email' in errors || 'invalidEmail' in errors}>
                    <Input variant="outline" placeholder="Утасны дугаар" style={[GlobalStyles.textInputStyle]}
                ...
                <FormControl isRequired style={{ backgroundColor: Colors.white }} isInvalid={submited && 'password' in errors}>
                    <Input variant="outline" placeholder="Таны нэр" style={[GlobalStyles.textInputStyle]}
                ...
                <Button
                    ...
                    onPress={() => login()}
                >
                    <Text style={GlobalStyles.buttonText}>Захиал</Text>
                </Button>
                <OtrixDivider size={'md'} />
                {loading && <OtrixLoader />}
