...
import {
    OtrixContainer, OtrixHeader, OtrixContent, OtirxBackButton, OtrixDivider, OtrixAlert
} from '@component';
...
function EditProfileScreen(props) {
    const [formData, setData] = React.useState({ first_name: null, last_name: null, email: null, mobileNumber: null, submited: false, loading: false, message: null, type: 'error' });
    const [errors, setErrors] = React.useState({});
    const [showMessage, setShowLoading] = React.useState(false)
    const { first_name, last_name, email, mobileNumber, submited, loading, message, type } = formData;
    ...
    return (
        <OtrixContainer>
            ...
            <OtrixContent>
                ...
                <FormControl style={{ backgroundColor: Colors.white }} isRequired isInvalid={submited && 'first_name' in errors}>
                    <Input variant="outline"
                        value={first_name}
                        placeholder="First Name" style={GlobalStyles.textInputStyle}
                        onChangeText={(value) => { setData({ ...formData, submited: false, first_name: value }), delete errors.first_name }}
                    />
                ...
                <FormControl style={{ backgroundColor: Colors.white }} isRequired isInvalid={submited && email == '' ? true : false}>
                    <Input variant="outline"
                        value={email}
