...
import {
    OtrixContainer, OtrixHeader, OtrixContent, OtrixDivider, OtrixLoader, OtirxBackButton, ManufacturersView
} from '@component';
        ...
        <OtrixContainer customStyles={{ backgroundColor: Colors.light_white }}>
            ...
            {/* Content Start from here */}
            {
                loading ? <CategorySkeleton /> : <OtrixContent >
                    ...
                    <ManufacturersView navigation={props.navigation} categoriesData={data} />
