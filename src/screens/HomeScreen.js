...
import {
    OtrixContainer, OtrixHeader, OtrixContent, OtrixDivider, HomeSlider, HomeManufacturerView,
...
function HomeScreen(props) {
    ...
    useEffect(() => {
        ...
        getApi.getData(
            ...
            console.log("responese answer----------",response.data.categories[0].title)
            console.log("responese status ----------",response.status)
        ...
        <OtrixContainer customStyles={{ backgroundColor: Colors.white }}>
            ...
            <OtrixHeader customStyles={{ backgroundColor: Colors.white }}>
                ...
                <View style={styles.headerCenter}>
                    <Text style={styles.headingTxt}>Zapas.mn </Text>
            ...
            {
                loading ? (<HomeSkeleton />,console.log('mylogs1...')) :
                    <OtrixContent >
                        ...
                        <HomeCategoryView navigation={props.navigation} data={homePageData.categories} />
                        
                    {/* <Text> {homePageData.categories}</Text> */}
                        ...
                        <NewProduct navigation={props.navigation} wishlistArr={wishlistData} data={homePageData.newProducts.length > 0 ? homePageData.newProducts.slice(0, 4) : []} arr={homePageData.newProducts}  addToWishlist={addToWish} userAuth={props.USER_AUTH} />
                        {/* <NewProduct navigation={props.navigation} wishlistArr={wishlistData} data={homePageData.newProducts.length > 0 ? homePageData.newProducts.slice(0, 4) : []} arr={homePageData.newProducts} addToWishlist={addToWish} userAuth={props.USER_AUTH} /> */}

                        {/* HomeManufacturerView Component */}
                        {/* <HomeManufacturerView navigation={props.navigation} data={homePageData.manufacturers} /> */}

                        {/* BestDeal Component */}
                        {/* <BestDeal navigation={props.navigation} data={homePageData.dodProducts.length > 0 ? homePageData.dodProducts.slice(0, 4) : []} arr={homePageData.dodProducts} wishlistArr={wishlistData} addToWishlist={addToWish} userAuth={props.USER_AUTH} /> */}
                        ...
                        {/* <TrendingProduct navigation={props.navigation} data={homePageData.trendingProducts.length > 0 ? homePageData.trendingProducts.slice(0, 4) : []} arr={homePageData.trendingProducts} wishlistArr={wishlistData} addToWishlist={addToWish} userAuth={props.USER_AUTH} /> */}
