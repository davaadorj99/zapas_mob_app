    ...
    return (
        <OtrixContainer>
            ...
            <OtrixContent>
                ...
                <FormControl isRequired isInvalid={submited && 'old_password' in errors} style={{ backgroundColor: Colors.white }}>
                    <Input variant="outline" placeholder="Old Password" style={[GlobalStyles.textInputStyle,]}
                        ...
                        value={old_password}
                        InputRightElement={
                            <TouchableOpacity onPress={() => { setDatapassword({ ...state, secureEntry: !state.secureEntry }), delete errors.old_password }} style={[{ marginRight: wp('3%') }]}>
