...
function LanguageScreen(props) {
    ...
    return (
        <OtrixContainer customStyles={{ backgroundColor: Colors.light_white }}>
            ...
            <TouchableOpacity style={[styles.langBox, { borderWidth: 1, borderColor: Colors.themeColor }]}>
                <Text style={[styles.langTxt, { color: Colors.themeColor }]}>English</Text>
            </TouchableOpacity>
            <View style={styles.langBox}>
                <Text style={[styles.langTxt, { opacity: 0.5 }]}>Arabic (Coming soon)</Text>
            </View>
