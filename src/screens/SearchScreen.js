...
import {
    OtrixContainer, SearchProductsViewComponent, OtrixLoader, OtirxBackButton, OtrixContent
} from '@component';
...
function SearchScreen(props) {
    const [state, setState] = React.useState({ data: [], searchKeyword: '', loading: false, showMost: true, showSuggestions: false });
        ...
        <OtrixContainer customStyles={{ backgroundColor: Colors.light_white }}>
...

            {
                showSuggestions && data.length > 0 && <OtrixContent>
                    <SearchProductsViewComponent navigation={props.navigation} products={data} />
                </OtrixContent>
            }
